  ...
  const {connectWallet,currentAccount,formData,sendTransaction,handleChange,isLoading}=useContext(TransactionContext);
    ...
    return (
     ...
     <p className="text-left text-white mt-5 font-light md:w-9/12 w-11/12 text-base">
        Explore the crypto world.Buy and sell cyrptocurrencies easily on krypto.
     </p>
     {!currentAccount&&(<button type="button" onClick={connectWallet}className="flex flex-row justify-center rounded-full items-center my-5 bg-[#2952e3] p-3 cursor-pointer hover:bg-[#2546bd]">
